...
def downgrade():
    ...
    op.drop_index(op.f('ix_job_pipeline_step_run_id'), table_name='job')
    ...
    op.drop_index(op.f('ix_pipeline_step_run_log_pipeline_step_run_id'), table_name='pipeline_step_run_log')
    ...
    op.drop_index(op.f('ix_pipeline_run_finish'), table_name='pipeline_run')
